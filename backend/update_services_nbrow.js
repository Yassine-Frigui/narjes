const mysql = require('my// NBrow Studio services (5 French services as specified)
...
// NBrow Studio services (5 French services as specified)
const nbrownServices = [
    {
        nom: 'Microblading',
...
async function updateServices() {
    ...
    try {
        ...
        // Insert new NBrow Studio services
        for (const service of nbrownServices) {
            await new Promise((resolve, reject) => {
                connection.query(
                    `INSERT INTO services (
                        nom, description, description_detaillee, prix, duree, image_url, 
